...
var memoizedDecrypt = _chunkRGAQJSYNcjs.memoizeOne.call(void 0, 
  (text) => _chunkJUWXY2C3cjs.decryptOverrides.call(void 0, text),
  (a, b) => a[0] === b[0],
...
function createFlagsDiscoveryEndpoint(getApiData, options) {
  return async (request) => {
    ...
    return new Response(JSON.stringify(apiData), {
      headers: {
        "x-flags-sdk-version": _chunkJUWXY2C3cjs.version,
...
function getRun(definition, decide) {
  return async function run(options) {
    ...
    if (cachedValue !== void 0) {
      _chunkJUWXY2C3cjs.setSpanAttribute.call(void 0, "method", "cached");
      const value = await cachedValue;
      return value;
    }
    if (overrides && overrides[definition.key] !== void 0) {
      _chunkJUWXY2C3cjs.setSpanAttribute.call(void 0, "method", "override");
      ...
      _chunkJUWXY2C3cjs.internalReportValue.call(void 0, definition.key, decision2, {
        reason: "override"
      });
      return decision2;
    }
    ...
    if (_optionalChain([definition, 'access', _13 => _13.config, 'optionalAccess', _14 => _14.reportValue]) !== false) {
      _chunkJUWXY2C3cjs.reportValue.call(void 0, definition.key, decision);
    }
    return decision;
  };
}
...
function flag(definition) {
  ...
  const flag2 = _chunkJUWXY2C3cjs.trace.call(void 0, 
    async (...args) => {
      _chunkJUWXY2C3cjs.setSpanAttribute.call(void 0, "method", "decided");
      if (typeof args[0] === "string" && Array.isArray(args[1])) {
        const [precomputedCode, precomputedGroup, secret] = args;
        if (precomputedCode && precomputedGroup) {
          _chunkJUWXY2C3cjs.setSpanAttribute.call(void 0, "method", "precomputed");
  ...
  flag2.origin = origin;
  flag2.options = _chunkRGAQJSYNcjs.normalizeOptions.call(void 0, definition.options);
  flag2.description = definition.description;
  flag2.identify = identify ? _chunkJUWXY2C3cjs.trace.call(void 0, identify, {
    isVerboseTrace: false,
    name: "identify",
    attributes: { key: definition.key }
  }) : identify;
  flag2.decide = _chunkJUWXY2C3cjs.trace.call(void 0, decide, {
    isVerboseTrace: false,
    name: "decide",
    attributes: { key: definition.key }
  });
  flag2.run = _chunkJUWXY2C3cjs.trace.call(void 0, run, {
    isVerboseTrace: false,
    name: "run",
    attributes: { key: definition.key }
  });
