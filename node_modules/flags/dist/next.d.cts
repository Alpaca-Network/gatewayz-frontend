import { J as JsonValue, f as FlagDeclaration, i as FlagOption, e as ApiData, g as FlagDefinitionType, P as ProviderData } from './types-lxHzenVJ.cjs';
...
type AppRouterFlag<ValueType, EntitiesType> = (() => Promise<ValueType>) & FlagMeta<ValueType, EntitiesType>;
