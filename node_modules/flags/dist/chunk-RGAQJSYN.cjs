...
async function serialize(flagSet, flags, secret) {
  ...
  const matchedIndices = new Uint8Array(
    flags.map((flag) => {
      ...
      if (!Object.hasOwn(flagSet, flag.key) || value === void 0) {
...
exports.normalizeOptions = normalizeOptions; exports.memoizeOne = memoizeOne; exports.deserialize = deserialize; exports.serialize = serialize;
//# sourceMappingURL=chunk-RGAQJSYN.cjs.map