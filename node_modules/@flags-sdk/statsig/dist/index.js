...
function createStatsigAdapter(options) {
  ...
  function featureGate(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        ...
        const gate = (opts == null ? void 0 : opts.exposureLogging) ? Statsig2.getFeatureGateSync(user, key) : Statsig2.getFeatureGateWithExposureLoggingDisabledSync(user, key);
  ...
  function dynamicConfig(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        ...
        const config = (opts == null ? void 0 : opts.exposureLogging) ? Statsig2.getConfigSync(user, configKey) : Statsig2.getConfigWithExposureLoggingDisabledSync(user, configKey);
  ...
  function experiment(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        const user = await predecide(entities);
        const experiment2 = (opts == null ? void 0 : opts.exposureLogging) ? Statsig2.getExperimentSync(user, key) : Statsig2.getExperimentWithExposureLoggingDisabledSync(user, key);
  ...
  function autotune(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        const user = await predecide(entities);
        const autotune2 = (opts == null ? void 0 : opts.exposureLogging) ? Statsig2.getConfigSync(user, key) : Statsig2.getConfigWithExposureLoggingDisabledSync(user, key);
  ...
  function layer(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        const user = await predecide(entities);
        const layer2 = (opts == null ? void 0 : opts.exposureLogging) ? Statsig2.getLayerSync(user, key) : Statsig2.getLayerWithExposureLoggingDisabledSync(user, key);
