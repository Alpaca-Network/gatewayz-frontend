...
var _chunk2ASCOQWEcjs = require('./chunk-2ASCOQWE.cjs');
...
function createStatsigAdapter(options) {
  ...
  async function predecide(user) {
    await initialize();
    syncHandler == null ? void 0 : syncHandler();
  ...
  function featureGate(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        ...
        const gate = (opts == null ? void 0 : opts.exposureLogging) ? _statsignodelite2.default.getFeatureGateSync(user, key) : _statsignodelite2.default.getFeatureGateWithExposureLoggingDisabledSync(user, key);
  ...
  function dynamicConfig(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        ...
        const config = (opts == null ? void 0 : opts.exposureLogging) ? _statsignodelite2.default.getConfigSync(user, configKey) : _statsignodelite2.default.getConfigWithExposureLoggingDisabledSync(user, configKey);
  ...
  function experiment(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        const user = await predecide(entities);
        const experiment2 = (opts == null ? void 0 : opts.exposureLogging) ? _statsignodelite2.default.getExperimentSync(user, key) : _statsignodelite2.default.getExperimentWithExposureLoggingDisabledSync(user, key);
  ...
  function autotune(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        const user = await predecide(entities);
        const autotune2 = (opts == null ? void 0 : opts.exposureLogging) ? _statsignodelite2.default.getConfigSync(user, key) : _statsignodelite2.default.getConfigWithExposureLoggingDisabledSync(user, key);
  ...
  function layer(getValue, opts) {
    return {
      ...
      decide: async ({ key, entities }) => {
        const user = await predecide(entities);
        const layer2 = (opts == null ? void 0 : opts.exposureLogging) ? _statsignodelite2.default.getLayerSync(user, key) : _statsignodelite2.default.getLayerWithExposureLoggingDisabledSync(user, key);
...
exports.Statsig = _statsignodelite2.default; exports.createDefaultStatsigAdapter = createDefaultStatsigAdapter; exports.createStatsigAdapter = createStatsigAdapter; exports.getProviderData = _chunk2ASCOQWEcjs.getProviderData; exports.resetDefaultStatsigAdapter = resetDefaultStatsigAdapter; exports.statsigAdapter = statsigAdapter;
