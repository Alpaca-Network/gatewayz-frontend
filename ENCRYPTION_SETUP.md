...
- `KEY_VERSION`: 1
- `KEYRING_1`: [REDACTED - Configured in Railway environment variables only]
...
```
AbCdEf1234567890+/AbCdEf1234567890+/AbCdEf==
```

**Note**: This is an example format only. Use the actual key generated by the command.
...
**Note**: Get your project, environment, and service IDs from the Railway dashboard or by running `railway status`.
