-- Add sample subscription plans (Fixed version)
-- This migration adds the missing column first, then adds comprehensive pricing plans
...
-- Update existing plans if they exist (add max_concurrent_requests if missing)
UPDATE plans SET 
