...
export const models: Model[] = [
  ...
  },
  {
    ...
    tokens: '21B tokens',
    category: 'Multimodal',
    description: 'Claude Opus 4.5 is Anthropic\'s most capable model, offering advanced reasoning, complex problem-solving, and nuanced understanding. Ideal for demanding professional and creative tasks.',
    developer: 'anthropic',
    context: 200,
    inputCost: 0.5,
    outputCost: 1.5,
  ...
  // Alibaba Cloud Models (served via Alibaba Cloud Model Studio API)
  // Note: developer is 'alibaba' to distinguish from generic Qwen models on other gateways
  {
    name: 'Qwen2.5 72B',
    isFree: false,
    tokens: '131K tokens',
