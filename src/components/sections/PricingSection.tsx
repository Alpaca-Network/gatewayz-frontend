...
const tiers = [
  {
    ...
    price: "$35",
    period: "/month",
    subtitle: "$35 in monthly credits (20% savings)",
    description: "Get started with AI-powered workflows",
    features: [
  ...
  },
  {
    ...
    price: "$120",
    period: "/month",
    subtitle: "$130 in monthly credits (27% savings)",
  ...
  },
  {
    ...
    price: "$350",
    period: "/month",
    subtitle: "$400 in monthly credits (30% savings)",
