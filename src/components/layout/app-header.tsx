...
export function AppHeader() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      authTiming.elapsedMs > 10000 &&
      !slowAuthToastShownRef.current
    ) {
  ...
  const mapLinkedAccount = useCallback(
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-[60] w-full h-[65px] border-b bg-header"
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          >
            ...
            <img
              src="/logo_black.svg"
              alt="Gatewayz"
              className="w-[28px] h-[28px] sm:w-[32px] sm:h-[32px] object-contain dark:hidden"
            />
            <span className="font-bold text-base sm:text-lg text-foreground dark:hidden hidden sm:inline-block">
              Gatewayz
            </span>
            ...
            <img
              src="/logo_white.png"
              alt="Gatewayz"
              className="w-[28px] h-[28px] sm:w-[32px] sm:h-[32px] object-contain hidden dark:block"
            />
            <span className="font-bold text-base sm:text-lg text-foreground hidden sm:dark:inline-block">
              Gatewayz
            </span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4 ml-auto">
          ...
          <div className="lg:hidden shrink-0">
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="w-[100dvw] sm:w-[400px] overflow-y-auto top-[65px] h-[calc(100dvh-65px)]"
                overlayClassName="top-[65px]"
              >
