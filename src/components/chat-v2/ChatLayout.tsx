...
export function ChatLayout() {
   ...
   if (!isAuthenticated) {
       return (
            <div className="flex h-[calc(100vh-130px)] items-center justify-center flex-col gap-4">
   ...
   return (
       <div className="flex h-[calc(100vh-130px)] w-full overflow-hidden bg-background">
           {/* Desktop Sidebar */}
