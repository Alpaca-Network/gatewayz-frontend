...
/**
 * Web-only Privy Provider
 *
 * This file contains the Privy SDK integration for web browsers.
 * It is dynamically imported by privy-provider.tsx ONLY on non-desktop platforms.
 *
 * IMPORTANT: This file should NEVER be imported on Tauri desktop.
 * The Privy SDK performs HTTPS checks during module initialization,
 * which will fail on tauri.localhost (HTTP).
 */
...
export function PrivyWebProvider({ children, className, storageStatus }: PrivyWebProviderProps) {
  ...
  const privyConfig = useMemo<PrivyClientConfig>(() => {
    ...
    if (disableEmbeddedWallets) {
      console.info("[Auth] Embedded wallets disabled (createOnLogin: 'off') - iOS in-app browser detected");
    }
