...
export async function POST(req: NextRequest) {
  try {
    ...
    // proration_behavior: 'create_prorations' will give credit for unused time
    ...
    console.log('[Stripe Downgrade] Subscription updated:', {
    ...
    return NextResponse.json({
      success: true,
      subscriptionId: updatedSubscription.id,
      message: `Successfully downgraded to ${newTier || 'Pro'} plan`,
    });
  } catch (error) {
