...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-65px)] has-onboarding-banner:h-[calc(100dvh-115px)] md:h-[calc(100dvh-130px)] md:has-onboarding-banner:h-[calc(100dvh-180px)]">
